        ...
        <ul class="header__navbar-list header__navbar-list-right">
          <li class="header__navbar-item header__navbar-item--notification">
            ...
            <div class="header__navbar-notification">
              <ul class="header__navbar-notification-list">
                <li class="header__navbar-notification-item">Thông báo 1</li>
                <li
                  class="header__navbar-notification-item header__navbar-notification-item--readed"
                >
                  Thông báo 1
                </li>
                <li class="header__navbar-notification-item">Thông báo 1</li>
          ...
          <li class="header__navbar-item">
            <a
              href=""
              class="header__navbar-item-link header__navbar-item-link--login"
              >Đăng nhập</a
            >
            <div class="header__navbar-item-login">
              Đăng nhập bằng fb để quản lý đơn hàng, thông báo
            </div>
          </li>
        </ul>
      </nav>
      <div class="header__search">
        ...
        <div class="search__cart">
          <div class="search__cart-order">
            ...
            <div class="search__cart-order-infor">
              <img
                alt=""
                class="search__cart-order-infor-no-item-icon"
              ...
              />
              <span class="search__cart-order-infor-no-item-label"
                >Chưa có sản phẩm nào</span
              >
            </div>
          </div>
          <svg
            class="search__cart-icon search__cart-icon--acount"
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
            y="0px"
            width="24"
...
.header {
  ...
  right: 0;
  z-index: 1;
  height: calc(var(--nav-height) + var(--header-search-height));
}
...
.header__navbar-list-right > .header__navbar-item--notification {
  position: relative;
}
...
.header__navbar-notification-item--readed {
  background-color: #fff2ee;
}

.header__navbar-item--notification:hover .header__navbar-notification {
  display: block;
}

.header__navbar-item--notification::after {
  content: "";
...
.search__cart-order:hover .search__cart-order-infor {
  display: block;
}

.search__cart-order-infor::before {
  content: "";
  border: 12px solid;
  border-color: transparent transparent #fff transparent;
  position: absolute;
...
.search__cart-order-infor-no-item-icon {
  margin: auto;
  display: block;
}

.search__cart-order-infor-no-item-label {
  text-align: center;
  display: block;
  font-size: 1.6rem;
}

.search__cart-icon--acount {
  display: none;
}
</style>